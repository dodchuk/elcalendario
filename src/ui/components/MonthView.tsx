...
const st = StyleSheet.create({
  ...
  monthBadge: { alignSelf: "flex-start", paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12, marginBottom: 8, backgroundColor: "rgba(255,255,255,0.05)", borderWidth: 1, borderColor: "transparent" },
  monthBadgeActive: { backgroundColor: "transparent", borderWidth: 1, borderColor: "#ff3b30" },
  monthTitleActive: { color: "#ff3b30" },
